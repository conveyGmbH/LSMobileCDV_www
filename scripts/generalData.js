...
(function () {
    ...
    WinJS.Namespace.define("Binding.Converter", {
        ...
        toOnlineColor: WinJS.Binding.converter(function (value) {
            var ret;
            if (!AppData.appSettings.odata.replActive ||
                AppRepl.replicator &&
                (AppRepl.replicator.state === "error" ||
                 AppRepl.replicator.state === "stopped")) {
                ret = Colors.offColor;
            } else if (value) {
