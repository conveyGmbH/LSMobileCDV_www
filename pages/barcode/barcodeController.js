...
(function () {
    ...
    WinJS.Namespace.define("Barcode", {
        Controller: WinJS.Class.derive(Application.Controller, function Controller(pageElement, commandList) {
            ...
            var refreshWaitTimeMs = AppData._persistentStates.visitorFlowInterval || 5000;//(AppData._persistentStates.odata.replInterval || 30) * 1000;
                                ...
                                return WinJS.Promise.timeout(0).then(function() {
                                    ...
                                    if (Barcode.waitingScans > 0) {
                                        ...
                                        if (AppData._persistentStates.odata.useOffline && AppRepl.replicator) {
                                            var numFastReqs = 10;
                                            AppRepl.replicator.run(AppData._persistentStates.odata.replInterval || numFastReqs);
                                        }
                                    }
                                });
                            } else {
