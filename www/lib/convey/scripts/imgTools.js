...
(function () {
    ...
    WinJS.Namespace.define("ImgTools", {
        Crop: WinJS.Class.define(function (data, square) {
            ...
            var okButtonText = document.createElement("span");
            ...
            var handleRadius = 20;
            var initialMargin = handleRadius * 1.5;
            var minSide = 100;
            ...
            function initRect() {
                ...
                if (square) {
                    var newSide;
                    if (width > height) {
                        newSide = height - 2 * initialMargin;
                        rect.top = initialMargin;
                        rect.left = (width - newSide) / 2 + initialMargin;
                    } else {
                        newSide = width - 2 * initialMargin;
                        rect.top = (height - newSide) / 2 + initialMargin;
                        rect.left = initialMargin;
                    }
                    rect.height = newSide - 2 * initialMargin;
                    rect.width = newSide - 2 * initialMargin;
                } else {
                    rect.left = initialMargin;
                    rect.top = initialMargin;
                    rect.width = width - 2 * initialMargin;
                    rect.height = height - 2 * initialMargin;
                }
            }
            ...
            function initElement() {
                ...
                if (closeButtonText.style) {
                    closeButtonText.style.display = square ? "none" : "block";
                    closeButtonText.style.color = "#ffffff";
                    closeButtonText.style.fontSize = "16px";
                    closeButtonText.style.textAlign = "center";
                    closeButtonText.style.cursor = "default";
                    closeButtonText.style.position = "absolute";
                    closeButtonText.style.left = "50px";
                    closeButtonText.style.bottom = "12px";
                }
                closeButtonText.textContent = getResourceText("imgTools.closeButton");
                ...
                navigationButtonsDiv.appendChild(closeButtonText);
                var okButtonBkg = document.createElement("span");
                if (okButtonBkg.style) {
                    okButtonBkg.style.height = "62px";
                    okButtonBkg.style.width = "62px";
                    okButtonBkg.style.borderWidth = "31px";
                    okButtonBkg.style.borderRadius = "31px";
                    okButtonBkg.style.display = "block";
                    okButtonBkg.style.position = "absolute";
                    okButtonBkg.style.right = "0";
                    okButtonBkg.style.bottom = "0";
                ...
                if (okButton.style) {
                    ...
                    okButton.style.bottom = "15.5px";
                    okButton.style.color = "#000000";
                }
                okButton.textContent = "\uE0E7"; // save
                if (okButtonText.style) {
                    //okButtonText.style.display = square ? "none" : "block";
                    okButtonText.style.color = "#ffffff";
                    okButtonText.style.fontSize = "16px";
                    okButtonText.style.textAlign = "center";
                    okButtonText.style.cursor = "default";
                    okButtonText.style.position = "absolute";
                    okButtonText.style.right = "70px";
                    okButtonText.style.bottom = "15px";
                }
                okButtonText.textContent = getResourceText("imgTools.okButton");
                navigationButtonsDiv.appendChild(okButton);
                navigationButtonsDiv.appendChild(okButtonText);
            ...
            function onOkButtonClick(e) {
                if (typeof complete === "function") {
                    ...
                    if (scale) {
                        ctx.drawImage(image, -rect.left / scale, -rect.top / scale, width / scale, height / scale);
                    } else {
                    ...
                    var run = function () {
                        if (typeof data !== "string") {
                            ...
                            image.onload = function () {
                                ...
                                closeButtonText.addEventListener('click', onCloseButtonClick);
                                okButton.addEventListener('click', onOkButtonClick);
                                okButtonText.addEventListener('click', onOkButtonClick);
                                initRect();
                                drawRectInCanvas();
