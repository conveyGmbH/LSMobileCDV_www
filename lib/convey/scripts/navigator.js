            ...
            function PageControlNavigator(element, options) {
                ...
                _navigated: function () {
                    ...
                    if (this._nextMaster === this._lastMaster) {
                        ...
                        if (this._nextMaster) {
                            var masterDataContainer = this.masterElement.querySelector(".data-container");
                            if (masterDataContainer && masterDataContainer.style) {
                                masterDataContainer.style.backgroundColor = "transparent";
                            }
