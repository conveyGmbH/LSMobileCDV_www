    ...
    WinJS.Namespace.define("Application", {
        ...
        showDetail: function (f) {
            if (Application.navigator && Application.navigator._nextMaster &&
                ...
                WinJS.Promise.timeout(50).then(function () {
                    Application.navigator._hideMaster().then(function() {
                    ...
                    if (AppBar.commandList && AppBar.commandList.length > 0 &&
                        ...
                        if (AppBar.barControl && AppBar.barControl.placement === "top") {
                            ...
                            if (Application.navigator.splitViewPane) {
                                appBarLeft += Application.navigator.splitViewPane.clientWidth;
                            }
                ...
                _beforenavigate: function (args) {
                    ...
                    if (isDisabled) {
                        ...
                        var checkCanUnload = function () {
                            ...
                            if (!(pageId === "register" || pageId === "recover" || (pageId === "account" && prevPageId === "login") || (pageId === "barcode" && prevPageId === "login") || pageId === "support") &&
