                    ...
                    if (element &&
                        ...
                        if (!element.winControl.inResize) {
                            ...
                            ret = WinJS.Promise.timeout(50).then(function() {
                                var ret2 = that.elementUpdateLayout(element);
                                Log.print(Log.l.u1, "...returned from updateLayout");
                                return ret2;
                            });
                        }
                    ...
                    if (element && element.style && splitViewContent) {
                        ...
                        if (navBarVisible) {
                            if (NavigationBar.orientation === "horizontal") {
                                top += AppData.persistentStatesDefaults.navHorzHeight;
                                height -= AppData.persistentStatesDefaults.navHorzHeight;
                                navBarElement = NavigationBar.ListView && NavigationBar.ListView.listElement;
                            } else {
                                left += AppData.persistentStatesDefaults.navVertWidth;
                                width -= AppData.persistentStatesDefaults.navVertWidth;
                            }
                        }
                        element.style.zIndex = "1";
                        element.style.left = left.toString() + "px";
    ...
    WinJS.Namespace.define("NavigationBar", {
            ...
            function ListViewClass(navigationBarPages, navigationBarGroups, options) {
                ...
                if (!NavigationBar._listViewVert) {
                    if (!NavigationBar._listViewHorz) {
                        ...
                        Colors.changeCSS(".navigationbar-container-horizontal", "height", AppData.persistentStatesDefaults.navHorzHeight.toString() + "px !important");
                    } else {
                        listOrientation = "vertical";
                        Colors.changeCSS(".navigationbar-container-vertical", "width", AppData.persistentStatesDefaults.navVertWidth.toString() + "px !important");
                        /*
                        ...
                        if (navigationbarContainerVertical && navigationbarContainerVertical.style) {
                            navigationbarContainerVertical.style.width = AppData.persistentStatesDefaults.navVertWidth.toString() + "px";
                        }
                         */
                    }
                } else {
                                            ...
                                            if (doAnimation) {
                                                if (NavigationBar._orientation !== "vertical") {
                                                    ...
                                                    if (textElements && textElements.length > 0) {
                                                        var horzHeight = -AppData.persistentStatesDefaults.navHorzHeight / 8;
            ...
            if (Application.navigator) {
                ...
                if (rootSplitViewPane && rootSplitViewPane.style) {
                    ...
                    if (splitViewRoot) {
                        ...
                        if (splitViewControl &&
                            splitViewControl.openedDisplayMode === WinJS.UI.SplitView.OpenedDisplayMode.overlay) {
                            rootSplitViewPane.style.marginTop = AppData.persistentStatesDefaults.navHorzHeight + "px";
                        } else {
        ...
        setItemsForGroup: function (group) {
            ...
            if (NavigationBar.data && group !== NavigationBar.curGroup) {
                ...
                if (NavigationBar._orientation === "vertical") {
                    var vertWidth = -AppData.persistentStatesDefaults.navVertWidth;
                    offset = { top: "0px", left: vertWidth.toString() + "px" };
                } else {
                    var horzHeight = -AppData.persistentStatesDefaults.navHorzHeight;
