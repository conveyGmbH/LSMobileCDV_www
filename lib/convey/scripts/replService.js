        ...
        DbReplicator: WinJS.Class.define(function dbReplicator() {
            ...
            selectReplicationFlowSpec: function () {
                ...
                var ret = new WinJS.Promise.as().then(function() {
                    ...
                    var stmt = "SELECT \"ReplicationFlowSpec\".*,\"ReplicationSpec\".\"RelationName\"," + postReplicationOrder + " AS \"ReplicationType\" FROM \"ReplicationFlowSpec\",\"ReplicationSpec\" WHERE \"ReplicationFlowSpec\".\"RelationID\"=\"ReplicationSpec\".\"RelationID\" ORDER BY \"ReplicationFlowSpec\".\"ReplicationFlowSpecID\" LIMIT 200"; /* */
                    var values = [];
                    Log.print(Log.l.info, "xsql: " + stmt + " [" + values + "]");
                    return SQLite.xsql(that._db, stmt, values, that._connectionType).then(function (res) {
