                                    ...
                                    AppBar.barControl._handleShowingKeyboardNew = function (event) {
                                        ...
                                        return ret.then(function () {
                                            ...
                                            if (Application.navigator.pageElement) {
                                                ...
                                                if (contentarea && contentarea.style) {
                                                    ...
                                                    if (occludedRect && occludedRect.height > 0) {
                                                        clientHeight -= occludedRect.height;
                                                    } else if (AppBar.commandList &&
                                                        ...
                                                        if (positionAppBar.top - positionContent.top < clientHeight) {
                                                            clientHeight = positionAppBar.top - positionContent.top;
                                                        }
                                                    }
                                                    contentarea.style.height = clientHeight + "px";
                                                }
                                            }
                                            ...
                                            if (activeElement &&
                                                ...
                                                activeElement._scrollIntoViewCheck();
                                            }
                                        });
                                    }
                                ...
                                function addScrollIntoViewCheck(input) {
                                    if (input) {
                                        ...
                                        input.onfocus = function (event) {
                                            input._scrollIntoViewCheck = function () {
                                                var activeElement = document.activeElement;
