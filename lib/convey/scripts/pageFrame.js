        ...
        PageFrame: WinJS.Class.define(
            ...
            function PageFrame(aName) {
                ...
                onResume: function () {
                    ...
                    var isRegister = !AppData._persistentStates.odata.login || !AppData._persistentStates.odata.password;
                    var url = AppData.getBaseURL(AppData.appSettings.odata.onlinePort) + "/" + AppData.getOnlinePath(isRegister) + "/$metadata";
                    var options = AppData.initXhrOptions("GET", url, isRegister);
                    Log.print(Log.l.info, "calling xhr method=GET metadata... url=" + options.url + " isRegister=" + isRegister);
