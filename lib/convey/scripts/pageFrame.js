        ...
        PageFrame: WinJS.Class.define(
            ...
            function PageFrame(aName) {
                    ...
                    if (typeof window.resolveLocalFileSystemURL === "function") {
                        try {
                            window.resolveLocalFileSystemURL(cordova.file.dataDirectory, function (dirEntry) {
                                        ...
                                        try {
                                            fileEntry.file(function (file) {
                                                try {
                                                    ...
                                                    Log.print(Log.l.error, "loadPersistentStates exception within FileReader error " + exception.message);
                                                    checkForLocalStorage();
                                                }
                                            }, function (errorResponse) {
                                                Log.print(Log.l.error, "loadPersistentStates file read error " + errorResponse.toString());
                                                checkForLocalStorage();
                                            });
                                        } catch (exception) {
                                            Log.print(Log.l.error, "loadPersistentStates fileEntry.file error " + exception.message);
                                            checkForLocalStorage();
                                        }
                                    }, function (errorResponse) {
                                        Log.print(Log.l.info, "loadPersistentStates getFile(" + Application.pageframe.filenamePSEncoded + ") error " + errorResponse.toString());
                                        try {
                                            dirEntry.getFile(Application.pageframe.filenamePersistentStates, { create: false, exclusive: false }, function (fileEntry) {
                                                try {
                                                    ...
                                                    Log.print(Log.l.error, "loadPersistentStates dirEntry.getFile error " + exception.message);
                                                    checkForLocalStorage();
                                                }
                                            }, function (errorResponse) {
                                                Log.print(Log.l.error, "loadPersistentStates getFile(" + Application.pageframe.filenamePersistentStates + ") error " + errorResponse.toString());
                                                checkForLocalStorage();
                                            });
                                        } catch (exception) {
                                            Log.print(Log.l.error, "loadPersistentStates dirEntry.getFile error " + exception.message);
                                ...
                                Log.print(Log.l.error, "loadPersistentStates resolveLocalFileSystemURL error " + errorResponse.toString());
                                checkForLocalStorage();
                            });
                        } catch (exception) {
                            Log.print(Log.l.error, "loadPersistentStates exception in resolveLocalFileSystemURL error " + exception.message);
                            checkForLocalStorage();
                        }
                    } else {
                        checkForLocalStorage();
                ...
                savePersistentStates: function () {
                    ...
                    if (Application.pageframe._inSavePersistentStates > 0) {
                    ...
                    } else if (!(AppData && AppData._persistentStates &&
                        AppData._persistentStates.odata &&
                        AppData._persistentStates.odata.serverFailure &&
                        !AppData._persistentStates.odata.dbinitIncomplete)) {
                        Application.pageframe._inSavePersistentStates++;
                        try {
                            if (window.localStorage) {
                                Log.print(Log.l.trace, "using localStorage: AppData._persistentStates " + AppData._persistentStates);
                                var data = JSON.stringify(AppData._persistentStates);
                                Log.print(Log.l.trace, "using localStorage data: " + data);
                                if (data) {
                                    var fileName;
                                    if (AppData._persistentStates.encodeSettings) {
                                        ...
                                        try {
                                            window.resolveLocalFileSystemURL(cordova.file.dataDirectory, function (dirEntry) {
                                                ...
                                                try {
                                                        ...
                                                        try {
                                                            fileEntry.createWriter(function (fileWriter) {
                                                                try {
                                                                    ...
                                                                    Log.print(Log.l.error, "savePersistentStates exception within fileWriter error " + exception.message);
                                                                    Application.pageframe._inSavePersistentStates--;
                                                                }
                                                            }, function (errorResponse) {
                                                            ...
                                                            Log.print(Log.l.error, "savePersistentStates fileEntry.createWriter error " + exception.message);
                                                            Application.pageframe._inSavePersistentStates--;
                                                        }
                                                    }, function (errorResponse) {
                                                    ...
                                                    Log.print(Log.l.error, "savePersistentStates dirEntry.getFile error " + exception.message);
                                                    Application.pageframe._inSavePersistentStates--;
                                                }
                                            }, function (errorResponse) {
                                            ...
                                            Log.print(Log.l.error, "savePersistentStates exception in resolveLocalFileSystemURL error " + exception.message);
                                            Application.pageframe._inSavePersistentStates--;
                                        }
                                    } else {
                        ...
                        Log.print(Log.l.error, "ServerFailure is set");
                    }
                    Log.ret(Log.l.trace);
                },
