        ...
        PageFrame: WinJS.Class.define(
            ...
            function PageFrame(aName) {
                ...
                onResume: function () {
                    ...
                    AppData._userRemoteDataPromise = WinJS.Promise.timeout(2000).then(function () {
                        if (typeof AppData.getUserRemoteData === "function") {
                            AppData.getUserRemoteData();
                        }
                        /*if (typeof AppData.getCRVeranstOption === "function") {
                            AppData.getCRVeranstOption();
                        }*/
                        if (typeof AppData.getMobileVersion === "function") {
